  ...
  return (
    <div className="min-h-screen pt-24 pb-16 px-4 md:px-8 relative overflow-hidden transition-colors duration-300 bg-slate-50 dark:bg-[#180305]">
      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
        ...
        <div className="p-6 md:p-8 rounded-3xl border shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden bg-gradient-to-r from-orange-50/90 via-amber-50/60 to-white dark:from-[#2E080C] dark:via-[#200508] dark:to-[#180305] border-orange-200/80 dark:border-[#701A1A]/60">
          
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-red-600/10 to-amber-500/10 rounded-full blur-3xl pointer-events-none" />

          <div className="relative z-10">
            <div className="flex items-center gap-2 text-xs font-black text-orange-600 dark:text-amber-400 uppercase tracking-widest mb-2 font-mono">
              <span className="w-2 h-2 rounded-full bg-orange-500 dark:bg-amber-400 animate-ping" /> Security Operations Command Center
            </div>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto relative z-10">
            {userRole === 'admin' && (
              <Link
                ...
                className="flex-1 md:flex-none px-5 py-3.5 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white font-black text-xs uppercase tracking-wider rounded-2xl transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
              >
            ...
            {userRole === 'superadmin' && (
              <Link
                to="/admin/approval"
                className="flex-1 md:flex-none px-5 py-3.5 bg-white dark:bg-[#2E080C] text-slate-700 dark:text-slate-200 font-bold text-xs uppercase tracking-wider rounded-2xl transition-all border border-slate-200 dark:border-[#5C121E] shadow-sm hover:bg-slate-50 dark:hover:bg-[#3D0A11] flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
              >
                <CheckSquare className="w-4 h-4 text-orange-600 dark:text-amber-400" /> Approvals Queue
              </Link>
            )}
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-3xl border shadow-sm space-y-4 bg-white dark:bg-slate-950/80 border-slate-200 dark:border-white/10">
              <h3 className="text-sm font-extrabold uppercase tracking-wider flex items-center justify-between text-slate-900 dark:text-white">
                ...
                <Car className="w-4 h-4 text-orange-600 dark:text-amber-400" />
              </h3>
            ...
            <div className="p-6 rounded-3xl border shadow-sm space-y-4 bg-white dark:bg-slate-950/80 border-slate-200 dark:border-white/10">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3 rounded-2xl border flex justify-between items-center bg-slate-50 dark:bg-slate-900/60 border-slate-200 dark:border-white/5">
                  ...
                  <span className="px-2.5 py-1 rounded-lg font-mono font-bold text-[10px] bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-500/30">On Duty</span>
                </div>
          ...
          <div className="lg:col-span-2 p-6 rounded-3xl border shadow-sm flex flex-col justify-between space-y-6 bg-white dark:bg-slate-950/80 border-slate-200 dark:border-white/10">
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link to="/history" className="text-xs font-bold text-orange-600 dark:text-amber-400 hover:underline flex items-center gap-1">
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-600 dark:text-slate-400 font-mono">
              ...
              <div className="flex items-center gap-3">
                <Link to="/reports" className="px-3.5 py-2 bg-slate-100 dark:bg-slate-900 text-slate-800 dark:text-white rounded-xl font-bold flex items-center gap-1.5 border border-slate-200 dark:border-white/10 shadow-sm">
                  <FileText className="w-3.5 h-3.5 text-orange-600 dark:text-amber-400" /> Gate Audit Reports
                </Link>
              </div>
            </div>
          </div>
